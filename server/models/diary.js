...
function Diary(name,title,post,image,type,location,price, liquidateDamages, startAt, endAt){
	this.name = name;
	this.title = title;
	this.post = post;
	this.image = image;
...
Diary.prototype.getAll = function(){
	...
	while(i < count){
			...
			var temp = {"name":it.name ,"title":it.title,"summary":it.summary,"image":it.image,"type":it.type,"location":it.location,"avatar":tempuser.avatar,"post":it.post,"price":it.price,"liquidateDamages":it.liquidateDamages,"startAt":it.startAt,"endAt":it.endAt};
